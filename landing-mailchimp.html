...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <title>Landing Maichimp - Ebookyo Responsive Ebook HTML5 Landing Page</title>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="hero-content">
                  <h1 class="hero-headline">There is No Friend As <Br> Loyal as a book.</h1>
                  <div class="hero-bio">we have on the web development market since 2000 and have been growing ever since. A design studio founded in London and expanded our services & become a multinational firm, offering features Worldwide.</div>
              ...
              <div class="col-12 col-md-6 col-lg-6"><img class="img-fluid float-right" src="assets/images/cover/book.png" alt="Book Cover"/></div>
            </div>
            <!-- End .row-->
          </div>
          <!-- End .hero-cotainer-->
          ...
          <div class="row clearfix">
            <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
              <div class="heading text-center">
                <h2 class="heading-title">Book Features</h2>
        ...
        <div class="container">
          <div class="row align-items-center h-100">
            <div class="col-12 col-md-12 col-lg-6">
              <div class="heading">
                <h2 class="heading-title">About The Book</h2>
                <p class="heading-desc">After all, as described in Web Design Trends vision dominates. power of simple and communication each make a lasting impression.</p>
              </div>
